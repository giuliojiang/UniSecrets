...
admin       1 if user should be shown some buttons to go to admin panels. This is NOT a security vulnerability because even if users force this flag in javascript, they can see the page but with no content from the server.